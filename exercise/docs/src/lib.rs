...
/*!
A pumpkin is a cultivated winter [squash](https://en.wikipedia.org/wiki/Winter_squash) in the genus Cucurbita.[1][2] The term is most commonly applied to round, orange-colored squash varieties, but does not possess a scientific definition. It may be used in reference to many different squashes of varied appearance and belonging to multiple species in the Cucurbita genus.[3]
!*/
...
**/
pub struct Pumpkin {
    /// Roundiness of orange in %
    pub roundness: f32,
    /// How orange is it between 8-27
    pub orangeness: i32,
}
...
impl Pumpkin {
    /// If you smash pumpkin, it will be gone 😭
    pub fn smash(self) {}
}
